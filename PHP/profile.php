...
<body>
    ...
    <header>
        ...
        <div class="header-content">
            <div class="header-title"style="margin-left: 0px;margin-right: 80px;">
                <h1>運命の一撃</h1>
                <h2>unmei no ichigeki anata no hada ni ichigeki wo</h2>
            </div>
        </div>
    </header>
    ...
    <main>
        ...
        <section class="user-info">
            ...
            <!-- 名前・性別編集フォーム -->
            <form id="user-edit-form" action="profile_update.php" method="POST" style="display:none;"style="display: block;padding-top: 20px;">
                <label for="name">名前:</label>
                <input type="text" id="name" name="name" value="<?php echo htmlspecialchars($user['name'] ?? ''); ?>" placeholder="名前を入力してください">
        ...
        <section class="allergy-section">
            ...
            <!-- アレルギー編集フォーム -->
            <form id="allergy-edit-form" action="profile_update.php" method="POST" style="display:none;"style="display: block;padding-top: 20px;">
                <label for="allergy">アレルギーを編集:</label>
                <input type="text" id="allergy" name="allergy" value="<?php echo htmlspecialchars($row['allergies'] ?? ''); ?>" placeholder="アレルギーを入力してください">
                <button type="submit" class="save">保存</button>
            </form>
